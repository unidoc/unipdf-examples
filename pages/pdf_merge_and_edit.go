 ...
 *
 * Run as: go run pdf_merge_and_edit.go output.pdf input1.pdf input2.pdf input3.pdf ...
 */
...
func main() {
	if len(os.Args) < 4 {
		...
		fmt.Printf("Usage: go run pdf_merge_and_edit.go output.pdf input1.pdf input2.pdf input3.pdf ...\n")
		os.Exit(0)
	}
