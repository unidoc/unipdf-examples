...
<paragraph margin="20 0 0 0">
<text-chunk font="times" font-size="13">2 individuals known as Alex Tenant and Joanna Tenant, hereinafter known as the “Tenant(s)”,
agree to the following:</text-chunk>
</paragraph>
...
following Two (2) Occupants to reside on the Premises in addition to the Tenant(s) mentioned
above: Alex Jr Tenant and Jill Tenant, hereinafter known as the “Occupant(s)”.</text-chunk>
</paragraph>

<paragraph margin="20 0 0 0">
<text-chunk font="times-bold" font-size="13">OFFER TO RENT: </text-chunk>
<text-chunk font="times" font-size="13">The Landlord hereby rents to the Tenant(s), subject to the following terms
and conditions of this Agreement, an apartment with the address of 1 Main Street, Apt 4, Small
Town, Alabama, 20992 consisting of 2.5 bathroom(s) and 2 bedroom(s) hereinafter known as
the “Premises”. The Landlord may also use the address for notices sent to the Tenant(s).</text-chunk>
</paragraph>
...
<paragraph margin="20 0 0 0">
<text-chunk font="times" font-size="13">Bedroom Set(s), Dining Room Set(s), Living Room Set(s) and all other furnishings to be
provided by the Tenant(s). Any damage to the Landlord's furnishings shall be the liability of the
Tenant(s), reasonable wear-and-tear excepted, to be billed directly or less the Security Deposit.</text-chunk>
</paragraph>
...
shall be the liability of the Tenant(s), reasonable wear-and-tear excepted, to be billed directly or
